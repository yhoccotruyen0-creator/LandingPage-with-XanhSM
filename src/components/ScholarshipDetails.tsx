        ...
        <ul className="mt-8 space-y-6">
          <li className="flex items-start gap-4 border-b border-[#eeeef0] pb-5 last:border-0 last:pb-0">
            ...
            <div>
              ...
              <p className="mt-1 font-sans text-sm font-semibold leading-relaxed text-on-surface-variant sm:text-base">
          ...
          <li className="flex items-start gap-4 border-b border-[#eeeef0] pb-5 last:border-0 last:pb-0">
            ...
            <div>
              ...
              <ul className="mt-1 space-y-2 font-sans text-sm font-semibold leading-relaxed text-on-surface-variant sm:text-base">
