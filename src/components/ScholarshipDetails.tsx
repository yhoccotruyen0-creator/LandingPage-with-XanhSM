      ...
      <div className="grid grid-cols-1 border-t border-[#dcefe2] bg-gradient-to-tr from-[#effbf4] to-white lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center p-6 sm:p-8">
          <button
            ...
            className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl border border-[#148144]/40 bg-white px-5 py-4 text-center font-headline text-sm font-bold leading-snug text-[#148144] transition-all hover:bg-[#f6fcf2] sm:text-base"
          >
